...
class Client_Soft_Params_Dfd1(object):
    ...
    modelName = "test1"
    modelNames = ["test1", "test2", "test3"]

    trainDsName = "多氟多_2#_质量软测#训练数据"
    trainDsDesc = "多氟多_2#_质量软测#, 训练"
    trainDsFile = "多氟多_2#_质量软测#训练数据.csv"
    trainDsParamFile = "质量软测量_2#_参数.csv"

    predDsName = "多氟多_2#_质量软测#在线数据"
    predDsDesc = "多氟多_2#_质量软测#, 预测分析"
    predDsFile = "2号软测量预测数据.csv"
