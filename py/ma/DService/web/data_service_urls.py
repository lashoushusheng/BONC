...
url_pattern_softMeasure = [
    ...
    # [预测]. 停止当前任务
    ('/analysis_api/v1/softMeasure/predict_current_task_stop',Predict_Current_Task_Stop.Predict_Current_Task_Stop_Handler),
    # [预测]. 分析任务提交.
...
url_pattern_greyPredict = [
    ...
    # [预测]. 停止当前任务
    ('/analysis_api/v1/greyPredict/predict_current_task_stop',Predict_Current_Task_Stop.Predict_Current_Task_Stop_Handler),
    # [预测]. 分析任务提交.
...
# [三次平滑指数预警分析]
url_pattern_holtWinters = [
    # [训练]. 添加-数据源.
    ('/analysis_api/v1/holtWinters/train_add_dataSource', Train_DataSource_Add.Train_Add_DataSource_Handler),
    # [训练] 获取-数据源列表.
    ('/analysis_api/v1/holtWinters/train_get_dataSource_list', Train_DataSource_List_Get.Train_Get_DataSource_List_Handler),
    # [训练] 选中-数据源.
    ('/analysis_api/v1/holtWinters/train_choiced_dataSource', Train_DataSource_Choiced.Train_Choiced_DataSource_Handler),
    # [训练] 保存模型.
    ('/analysis_api/v1/holtWinters/train_save_model', Train_Model_Save.Train_Save_Model_Handler),
    # [训练] 获取-模型参数.
    ('/analysis_api/v1/holtWinters/train_get_modelParams', Train_Model_Params_Get.Train_Get_Model_Params_Handler),
    # [训练] 获取-模型名称列表.
    ('/analysis_api/v1/holtWinters/train_get_modelNameList', Train_ModelNameList_Get.Train_Get_ModelNameList_Handler),
    # [训练] 查询-训练结果.
    ('/analysis_api/v1/holtWinters/train_query_result', Train_Result_Query.Train_Query_Result_Handler),

    # [预测]. 添加-数据源.
    ('/analysis_api/v1/holtWinters/predict_add_dataSource', Predict_DataSource_Add.Predict_Add_DataSource_Handler),
    # [预测]. 获取-数据源列表.
    ('/analysis_api/v1/holtWinters/predict_get_dataSource_list', Predict_DataSource_List_Get.Predict_Get_DataSource_List_Handler),
    # [预测]. 停止当前任务
    ('/analysis_api/v1/holtWinters/predict_current_task_stop',Predict_Current_Task_Stop.Predict_Current_Task_Stop_Handler),
    # [预测]. 分析任务提交.
    ('/analysis_api/v1/holtWinters/predict_task_commit', Predict_Task_Commit.Predict_Commit_Task_Handler),
    # [预测]. 多个分析任务提交.
    ('/analysis_api/v1/holtWinters/predict_multiple_task_commit', Predict_multiple_Task_Commit.Predict_Commit_multiple_Task_Handler),
    # [预测]. 获取-模型名称列表.
    ('/analysis_api/v1/holtWinters/Predict_Get_Model_NameList', Predict_ModelNameList_Get.Predict_Get_ModelName_List_Handler),
    # [预测]. 查询-分析结果.
    ('/analysis_api/v1/holtWinters/predict_query_result', Predict_Result_Query.Predict_Query_Result_Handler),
    # [预测] 查询-多个分析结果
    ('/analysis_api/v1/holtWinters/predict_multiple_query_result', Predict_multiple_Result_Query.Predict_Query_multiple_Result_Handler),
]
urls_pattern += url_pattern_holtWinters
