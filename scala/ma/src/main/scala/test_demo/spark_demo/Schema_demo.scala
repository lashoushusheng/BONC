...
object Schema_demo {
  def main(args: Array[String]): Unit = {
    ...
    val dfdRDD: RDD[String] = spark.sparkContext.textFile("/root/works/src/git_test/rtc/poc_MAnalysis/scala/ma/data/DFD/online.csv")
    ...
    val rowRDD: RDD[Row] = dfdRDD.map(_.split(",")).map(t => Row.fromSeq(t))
