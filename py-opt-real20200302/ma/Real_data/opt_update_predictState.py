...
def update_predictState():
    predDsDir = Cli_Optmi_Params_Dfd1.predDsDir
    predDsFile = Cli_Optmi_Params_Dfd1.predDsFile
    ...
    while True:
        ...
        if currenttime != inittime:
            ...
            Mysql_MA_Real_time.mysql_update_predictState(Cli_Optmi_Params_Dfd1.modelType, Cli_Optmi_Params_Dfd1.predDsName)
            print("更新状态")
